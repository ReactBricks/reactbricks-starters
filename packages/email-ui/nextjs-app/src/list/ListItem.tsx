import { types, Text, Image, Link, isAdmin } from 'react-bricks/rsc'
...
EmailListItem.schema = {
  ...
  playgroundLinkUrl:
    'https://github.com/ReactBricks/reactbricks-starters/blob/main/packages/email-ui/nextjs-app/src/list/ListItem.tsx',
