import { types, Image, Text, Repeater, isAdmin } from 'react-bricks/rsc'
...
const ArticleAuthor: types.Brick<ArticleAuthorProps> = ({
  ...
  return (
    ...
    >
      <Row
        width={'100%'}
        className="max-w-full min-h-[100px] items-center"
      ...
      >
        <Column
          valign="middle"
          width="48px"
          className="inline-block max-w-[48px] text-left ml-[18px] md:ml-0 mb-1 md:mb-0"
        >
          {isAdmin() ? (
            <Image
              propName="image"
        ...
        <Column
          valign="middle"
          width="calc(100% - 48px)"
          className="ml-[18px] inline-block text-left align-top max-w-[200px] w-full"
        >
          <Text
            propName="name"
            value={name}
...
ArticleAuthor.schema = {
  ...
  playgroundLinkUrl:
    'https://github.com/ReactBricks/reactbricks-starters/blob/main/packages/email-ui/nextjs-app/src/article-authors/Author.tsx',
