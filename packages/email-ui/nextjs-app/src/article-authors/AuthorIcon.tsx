...
import { types, Link, isAdmin, Image } from 'react-bricks/rsc'
...
AuthorIcon.schema = {
  ...
  playgroundLinkUrl:
    'https://github.com/ReactBricks/reactbricks-starters/blob/main/packages/email-ui/nextjs-app/src/article-authors/AuthorIcon.tsx',
