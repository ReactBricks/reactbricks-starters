import { types, Text, isAdmin, Image } from 'react-bricks/astro'
...
const FeatureRow: types.Brick<FeatureRowProps> = ({
  ...
  return (
    <Row className="mt-[16px]">
      ...
      >
        <table className={'rounded-full w-12 h-12  ' + iconBgColor?.className}>
          <tbody>
            <tr>
      ...
      {featureStyle === '4' && (
        ...
        >
          <table
            className={'rounded-full w-12 h-12  ' + iconBgColor?.className}
          >
            <tbody>
              <tr>
                <td align="center" valign="middle">
...
FeatureRow.schema = {
  ...
  playgroundLinkUrl:
    'https://github.com/ReactBricks/reactbricks-starters/blob/main/packages/email-ui/astro/src/features/FeaturesRow.tsx',
