...
import { Image, Link, Repeater, Text, isAdmin, types } from 'react-bricks/astro'

import { titleSideEditProps } from '../LayoutSideProps'
import Title, { type TitleProps } from '../shared/components/Title'
...
ArticleImage.schema = {
  ...
  playgroundLinkUrl:
    'https://github.com/ReactBricks/reactbricks-starters/blob/main/packages/email-ui/astro/src/article-image/ArticleImage.tsx',
  getDefaultProps: () => ({
    eyebrow: "What's new",
