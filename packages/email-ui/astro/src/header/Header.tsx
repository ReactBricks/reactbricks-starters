import { Image, Repeater, types, isAdmin } from 'react-bricks/astro'
...
const Header: types.Brick<HeaderProps> = ({
  ...
  return centered ? (
    <Section className="my-[40px] py-[40px]">
      <Row>
        <Column align="center">
          {isAdmin() ? (
            <Image
...
Header.schema = {
  ...
  playgroundLinkUrl:
    'https://github.com/ReactBricks/reactbricks-starters/blob/main/packages/email-ui/astro/src/header/Header.tsx',
  getDefaultProps: () => ({
    centered: false,
    menuItems: [
      {
