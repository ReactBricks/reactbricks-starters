import { types, Text, Image, isAdmin } from 'react-bricks/astro'
...
ArticleCardsRow.schema = {
  ...
  playgroundLinkUrl:
    'https://github.com/ReactBricks/reactbricks-starters/blob/main/packages/email-ui/astro/src/article-cards/ArticleCardsRow.tsx',
