...
import { Image, Repeater, types, useAdminContext } from 'react-bricks/frontend'
...
Header.schema = {
  ...
  playgroundLinkUrl:
    'https://github.com/ReactBricks/reactbricks-starters/blob/main/packages/email-ui/nextjs-pages/src/header/Header.tsx',
  getDefaultProps: () => ({
    centered: false,
    menuItems: [
      {
