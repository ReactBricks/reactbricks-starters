...
export const emailBackgroundColorsEditProps: types.ISideEditProp<{
  backgroundColor: RBUIColor
}> = {
  name: 'backgroundColor',
  label: 'Background',
  ...
  selectOptions: {
    ...
    options: [
      emailBgColors.WHITE,
      emailBgColors.LIGHT_GRAY,
      emailBgColors.GRAY,
      emailBgColors.ROSE,
      emailBgColors.ORANGE,
      emailBgColors.AMBER,
      emailBgColors.YELLOW,
      emailBgColors.LIME,
      emailBgColors.GREEN,
      emailBgColors.EMERALD,
      emailBgColors.TEAL,
      emailBgColors.CYAN,
      emailBgColors.SKY,
      emailBgColors.BLUE,
      emailBgColors.INDIGO,
      emailBgColors.VIOLET,
      emailBgColors.PURPLE,
      emailBgColors.FUCHSIA,
      emailBgColors.DARK_GRAY,
    ],
  },
}
...
export const emailBackgroundSideGroup: types.ISideGroup<{
  backgroundColor: RBUIColor
}> = {
  groupName: 'Background',
  props: [emailBackgroundColorsEditProps],
}
...
export const iconColorsSideEditProps: types.ISideEditProp[] = [
  {
    name: 'iconBgColor',
    label: 'Icon bg Color',
    type: types.SideEditPropType.Select,
  ...
  },
  {
    ...
    selectOptions: {
      display: types.OptionsDisplay.Color,
      options: iconAccentColors,
    },
  },
]

export const titleSideEditProps: types.ISideGroup[] = [
  {
    groupName: 'Title',
    defaultOpen: false,
    props: [
      ...
      },
      {
        ...
        selectOptions: {
          display: types.OptionsDisplay.Color,
          options: textAccentColorOptions,
        },
      },
    ],
  },
