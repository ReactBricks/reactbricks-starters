        ...
        >
          ...
          >
            ...
            <RichText
              ...
              // plugins={[plugins.bold, plugins.italic, plugins.link]}
              allowedFeatures={[
...
TextMedia.schema = {
  ...
  playgroundLinkUrl:
    'https://github.com/ReactBricks/reactbricks-starters/blob/main/packages/reactbricks-ui/astro/src/mainContent/TextMedia/TextMedia.tsx',
  getDefaultProps: () => ({
    ...sectionDefaults,
