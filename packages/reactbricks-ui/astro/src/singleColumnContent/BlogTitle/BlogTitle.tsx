...
// import { getPageValues, Text, types } from 'react-bricks/astro'
import {
  Text,
  types,
...
import { sectionDefaults } from '../../LayoutSideProps'
...
const BlogTitle: types.Brick<BlogTitleProps> = ({
  ...
  // const pageValues = reactBricksAstroStore.getPageValues()
