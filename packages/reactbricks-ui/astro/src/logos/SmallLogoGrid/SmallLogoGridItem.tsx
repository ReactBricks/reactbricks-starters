...
import { Image, Link, types } from 'react-bricks/astro'
...
SmallLogoGridItem.schema = {
  ...
  playgroundLinkUrl:
    'https://github.com/ReactBricks/reactbricks-starters/blob/main/packages/reactbricks-ui/astro/src/logos/SmallLogoGrid/SmallLogoGridItem.tsx',
