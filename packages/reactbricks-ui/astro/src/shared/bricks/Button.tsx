...
// import { Text, Link, types, isAdmin } from 'react-bricks/astro'
...
Button.schema = {
  ...
  playgroundLinkUrl:
    'https://github.com/ReactBricks/reactbricks-starters/blob/main/packages/reactbricks-ui/astro/src/shared/bricks/Button.tsx',
